...
if __name__=="__main__":
    data_parser = DataParser_V2()
    tick_numbers = ['1000', '10000', '100000', '1000000']
    for tick_number in tick_numbers:
        execution_time = timeit.timeit(lambda: data_parser.parse_ticks(f'../test_data/test_ticks_{tick_number}.bin'),number=10)
